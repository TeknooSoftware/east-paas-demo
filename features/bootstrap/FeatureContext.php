...
class FeatureContext implements Context
{
    ...
    private function buildObjectManager()
    {
    ...
    public function iHaveAConfiguredPlatform()
    {
        ...
        $this->container->get(DatesService::class)
    ...
    public function iCallThePaasWithThisPutRequest($url)
    {
        ...
        $request = Request::create('https://'.$this->container->get('app.paas.hostname').$this->calledUrl, 'PUT', [], [], [], [], $this->requestBody);
    ...
    public function iCallThePaasWithThisPutRequestWithBodyAndContentTypeDefinedTo($url, $body, $contentType)
    {
        ...
        $request = Request::create('https://'.$this->container->get('app.paas.hostname').$this->calledUrl, 'PUT', [], [], [], ['CONTENT_TYPE' => $contentType], $this->requestBody);
        $this->response = $this->kernel->handle($request);
    }
    ...
    public function iPushANewMessageAtTo($text, $date, $url)
    {
        ...
        $request = Request::create('https://'.$this->container->get('app.paas.hostname').$this->calledUrl, 'PUT', [], [], [], [], $body);
        $this->response = $this->kernel->handle($request);
    }
